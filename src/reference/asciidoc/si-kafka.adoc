...
[[new-in-sik]]
==== What's new in Spring Integration for Apache Kafka (version 3.3)

* <<si-channels>>

* You can now optionally flush the producer after a send; see <<si-outbound>> for more information.
